...
int32_t msm_sensor_driver_probe(void *setting)
{
...
#if defined(CONFIG_MACH_ULC83G_EUR) || defined(CONFIG_MACH_MILLET3G_EUR) || defined(CONFIG_MACH_CRATERQ_CHN_OPEN)  // Added for YUV bringup 
    ...
    /* remove this code for DFMS test for MS01*/
#if defined(CONFIG_MACH_ULC83G_EUR) || defined(CONFIG_MACH_MILLET3G_EUR)|| defined(CONFIG_MACH_CRATERQ_CHN_OPEN) // Added for YUV bringup ToDo.
    /* Power down */
