...
#if (defined(CONFIG_MACH_MS01_EUR_3G) || defined(CONFIG_MACH_MS01_LTE) || defined(CONFIG_MACH_CRATERQ) || \
defined(CONFIG_MACH_MS01_CHN_CMCC_3G) || defined(CONFIG_MACH_MS01_CHN_CU_3G) || defined(CONFIG_MACH_MS01_LTE_KOR) || defined(CONFIG_MACH_BAFFIN2_CHN_CMCC))
