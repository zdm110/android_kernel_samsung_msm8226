...
#if !defined(CONFIG_MACH_MILLET3G_EUR) && !defined(CONFIG_MACH_CS03_SGLTE) && !defined(CONFIG_MACH_CRATERQ)
	{
...
#endif
#if !defined(CONFIG_MACH_MILLET3G_EUR) && !defined(CONFIG_MACH_S3VE_CHN_OPEN) &&!defined(CONFIG_MACH_S3VE_CHN_CMCC) && !defined(CONFIG_MACH_S3VE_CHN_CTC) && !defined(CONFIG_MACH_CS03_SGLTE) 
	{
